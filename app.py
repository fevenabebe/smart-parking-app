...
st.write("Upload an image of a parking lot to predict parking availability.")
...
def preprocess_image(image: Image.Image):
    ...
    # Resize as per your model's training input size
    img_resized = cv2.resize(img_array, (224, 224))  # Change if your model used another size
    
    # Normalize if your model was trained on [0,1] range
...
if uploaded_file is not None:
    ...
    st.success(f"Prediction: {prediction[0]}")  # Adjust this line depending on your model output
